...
export function SnippetDialog({ open, onOpenChange, snippet, onSubmit }: SnippetDialogProps) {
        ...
        <div className="space-y-4 py-4 flex-1 min-h-0 overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="My Snippet" />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Input value={tags} onChange={(e) => setTags(e.target.value)} placeholder="react, hooks, utils" />
          </div>
        </div>
